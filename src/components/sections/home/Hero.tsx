        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary">
              ...
              Handcrafted Excellence Since 2018
            </div>

            {/* Headline */}
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Exquisite handmade jewelry in
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Discover our collection of artisan-crafted gold jewelry. Each piece is uniquely
              designed and meticulously handmade by skilled artisans using traditional techniques.
            </p>

            {/* Feature list */}
            <ul className="mt-6 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
              {[
                '18k solid gold guarantee',
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Handcrafted gold jewelry collection featuring rings, necklaces and earrings"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">500+</span> pieces crafted
              </p>
            </div>
          </div>
        </div>
