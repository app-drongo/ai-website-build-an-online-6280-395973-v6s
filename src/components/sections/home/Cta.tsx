...
export default function Cta() {
  const stats = [
    ...
    { value: '24K', label: 'Pure Gold', icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each piece tells a story of masterful craftsmanship and timeless elegance. Find
                jewelry that celebrates your unique style and precious moments.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in luxury lifestyle magazines
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Magazine logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Every piece comes with gold purity certification
              </p>
            </div>
          </div>
        </div>
