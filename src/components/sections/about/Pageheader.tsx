          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">24</span> Rings in Collection
              </span>
            </div>
            ...
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">GIA Certified</span> diamonds
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">Free</span> ring sizing included
            </div>
          </div>
        </div>
      </div>
